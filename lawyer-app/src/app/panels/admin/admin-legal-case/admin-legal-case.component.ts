...
@Component({
  selector: 'app-admin-legal-case',
  templateUrl: './admin-legal-case.component.html',
  styleUrls: ['./admin-legal-case.component.css'],
  animations: [
...
export class AdminLegalCaseComponent implements AfterViewInit {

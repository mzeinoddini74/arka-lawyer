...
@Component({
  selector: 'app-tel-select-category',
  templateUrl: './tel-select-category.component.html',
  styleUrls: ['./tel-select-category.component.css']
})
export class TelSelectCategoryComponent implements OnInit {
